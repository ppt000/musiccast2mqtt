...
#import musiccast2mqtt.__version__
from musiccast2mqtt import __version__

# -- Project information -----------------------------------------------------

project = u'musiccast2mqtt'
...
htmlhelp_basename = 'musiccast2mqttdoc'
...
latex_documents = [
    (master_doc, 'musiccast2mqtt.tex', u'musiccast2mqtt Documentation',
...
man_pages = [
    (master_doc, 'musiccast2mqtt', u'musiccast2mqtt Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'musiccast2mqtt', u'musiccast2mqtt Documentation',
     author, 'musiccast2mqtt', 'One line description of project.',
     'Miscellaneous'),
]
